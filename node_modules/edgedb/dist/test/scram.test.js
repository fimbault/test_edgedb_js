...
test("scram: RFC example", async () => {
    ...
    const saltedPassword = scram.getSaltedPassword(Buffer.from(scram.saslprep(password), "utf-8"), Buffer.from(salt, "base64"), iterations);
    ...
    const clientSignature = scram.HMAC(storedKey, Buffer.from(authMessage, "utf8"));
    ...
    expect(serverProof.toString("base64")).toBe("6rriTRBi23WpRR/wtup+mMhUZUn/dB5nLTJRsjl95G4=");
});
