...
class NamedTupleCodec extends ifaces_1.Codec {
    constructor(tid, codecs, names) {
        ...
        this.tupleCls = namedtuple_1.generateType(names);
    }
    encode(_buf, _object) {
    ...
    encodeArgs(args) {
        if (args == null) {
            throw new Error("a named arguments was expected, got a null value instead");
        }
    ...
    decode(buf) {
        ...
        if (els !== subCodecs.length) {
            throw new Error(`cannot decode NamedTuple: expected ` +
